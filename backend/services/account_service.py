...
class AccountService:
    ...
    async def create_account(self, account_in: AccountCreate, user_id: int) -> Account:
        ...
        log.info(
            "Service: Creating account '{}' for user {}",
        ...
        if existing:
            log.warning(
                "Service: Account '{}' already exists for user {}",
                account_in.account_name,
                user_id,
            )
    ...
    async def update_account(
        self, account_id: int, user_id: int, account_update: AccountUpdate
    ) -> Account:
        """Business logic for updating an account"""
        log.info(
            "Service: Updating account {} for user {}",
            account_id,
            user_id,
        )
    ...
    async def delete_account(self, account_id: int, user_id: int) -> None:
        ...
        log.info("Service: Deleting account {} for user {}", account_id, user_id)
